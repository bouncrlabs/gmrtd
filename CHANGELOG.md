...
## [2.0.0](https://github.com/bouncrlabs/gmrtd/compare/v1.2.0...v2.0.0) (2026-09-24)


### ⚠ BREAKING CHANGES

* **reader:** report read progress as a typed status ([#449](https://github.com/bouncrlabs/gmrtd/issues/449))

### Features

* (ECDSA) Active auth signature validation ([#62](https://github.com/bouncrlabs/gmrtd/issues/62)) ([468430c](https://github.com/bouncrlabs/gmrtd/commit/468430c7bd763d6e5903ccd73814b65fb20e064b))
* [fixes [#67](https://github.com/bouncrlabs/gmrtd/issues/67)] update DE Master List to Aug 2025 version ([#68](https://github.com/bouncrlabs/gmrtd/issues/68)) ([7c12bb3](https://github.com/bouncrlabs/gmrtd/commit/7c12bb30b6fb5460afabcc5613918f1d7191136d))
* **activeauth:** capture AA evidence and add offline VerifyEvidence ([#372](https://github.com/bouncrlabs/gmrtd/issues/372)) ([8f8355e](https://github.com/bouncrlabs/gmrtd/commit/8f8355eb624d05b1c75249b524f6b8b3a3cd8e34))
* add computed Age/PossibleAges to IdentityAttributes and HTML report (fixes [#462](https://github.com/bouncrlabs/gmrtd/issues/462)) ([#463](https://github.com/bouncrlabs/gmrtd/issues/463)) ([d0c37b2](https://github.com/bouncrlabs/gmrtd/commit/d0c37b275475ef6b950deabca636d3f288b873dc))
* add DocumentSummary; compute Summary on demand ([#422](https://github.com/bouncrlabs/gmrtd/issues/422)) ([8dfb6eb](https://github.com/bouncrlabs/gmrtd/commit/8dfb6ebb31e4f6e4c09d701edc03784418a14b0c))
* add gmrtd-verify offline document verifier CLI ([#401](https://github.com/bouncrlabs/gmrtd/issues/401)) ([ea86baf](https://github.com/bouncrlabs/gmrtd/commit/ea86bafb47aff2830025e8d92f26c024937da23b))
* add mobile package ([#35](https://github.com/bouncrlabs/gmrtd/issues/35)) ([4351f71](https://github.com/bouncrlabs/gmrtd/commit/4351f71c4cd544b5d44d066c948a2569da6a035d))
* add pcsc-reader app ([#41](https://github.com/bouncrlabs/gmrtd/issues/41)) ([fe3f726](https://github.com/bouncrlabs/gmrtd/commit/fe3f7265fede495c525bd67d02ffb69498be7764))
* add sample-document generation for mobile bindings and gmrtd-reader CLI ([#418](https://github.com/bouncrlabs/gmrtd/issues/418)) ([fe7a838](https://github.com/bouncrlabs/gmrtd/commit/fe7a83865d3642ba95e2843933ad5fac089a1c69))
* add SkipImages option during NFC read ([#318](https://github.com/bouncrlabs/gmrtd/issues/318)) ([922c41f](https://github.com/bouncrlabs/gmrtd/commit/922c41f9722474f2d5c43eb9e0c2a704c822d842))
* add support for Indonesia 2010 CSCA Series certificates ([#14](https://github.com/bouncrlabs/gmrtd/issues/14)) ([#97](https://github.com/bouncrlabs/gmrtd/issues/97)) ([defbabc](https://github.com/bouncrlabs/gmrtd/commit/defbabc30ec1b2426fe14f1a29f611387a20225c))
* add support for ISO-39794 ([#38](https://github.com/bouncrlabs/gmrtd/issues/38)) ([ad82044](https://github.com/bouncrlabs/gmrtd/commit/ad8204401fd827bd91c99eb6fb283620b18c1c1a))
* align DG2 images with DG7 ([#82](https://github.com/bouncrlabs/gmrtd/issues/82)) ([73cb65b](https://github.com/bouncrlabs/gmrtd/commit/73cb65ba014cd8c1ec5b07472ac92e034fb18a43))
* caller-supplied AA challenge with relay-attack nonce binding ([#397](https://github.com/bouncrlabs/gmrtd/issues/397)) ([8fa49a3](https://github.com/bouncrlabs/gmrtd/commit/8fa49a349362a6f435063a773b6096792645d1aa))
* **chipauth,pace:** capture terminal public keys and SSC in evidence; strengthen VerifyEvidence ([#387](https://github.com/bouncrlabs/gmrtd/issues/387)) ([cb21794](https://github.com/bouncrlabs/gmrtd/commit/cb21794bbec2128e62184632ebc4c81b6ba3a034))
* **chipauth:** capture CA evidence and add offline VerifyEvidence ([#370](https://github.com/bouncrlabs/gmrtd/issues/370)) ([83429f5](https://github.com/bouncrlabs/gmrtd/commit/83429f54d5991f29975960a8e83fddbb1ea81676))
* **cmd/gmrtd-csca:** add -country filter and -json output flags ([#483](https://github.com/bouncrlabs/gmrtd/issues/483)) ([a7c49d6](https://github.com/bouncrlabs/gmrtd/commit/a7c49d69c8347c5191bb8fd312e7c28c86e66d55))
* **cms:** Add EC curve fallback (fixes [#220](https://github.com/bouncrlabs/gmrtd/issues/220)) ([#221](https://github.com/bouncrlabs/gmrtd/issues/221)) ([32a8809](https://github.com/bouncrlabs/gmrtd/commit/32a8809a2c45094cac45bef8299c6f1b07f4ef03))
* **cms:** display full Subject DN (RFC 4514) instead of CN in gmrtd-… ([#359](https://github.com/bouncrlabs/gmrtd/issues/359)) ([7b84cf3](https://github.com/bouncrlabs/gmrtd/commit/7b84cf3467b50b8605834c76a3fcfca8f76f684a))
* **cms:** update to latest NL CSCA master-list (2026-06-09) (fixes [#361](https://github.com/bouncrlabs/gmrtd/issues/361)) ([#362](https://github.com/bouncrlabs/gmrtd/issues/362)) ([b4f0b26](https://github.com/bouncrlabs/gmrtd/commit/b4f0b2662552c834538d20d8554df24efac6be9b))
* CSCA master-list enhancements ([#25](https://github.com/bouncrlabs/gmrtd/issues/25)) ([3a5c3ad](https://github.com/bouncrlabs/gmrtd/commit/3a5c3adb11646d40d5161f95863de0b56964cceb))
* **csca:** CSCA utility (fixes [#289](https://github.com/bouncrlabs/gmrtd/issues/289)) ([#290](https://github.com/bouncrlabs/gmrtd/issues/290)) ([31f3b22](https://github.com/bouncrlabs/gmrtd/commit/31f3b22dfa2443b7aebaae3aaa2d9de2c432876c))
* **csca:** update DE CSCA Master-List (fixes [#241](https://github.com/bouncrlabs/gmrtd/issues/241)) ([#242](https://github.com/bouncrlabs/gmrtd/issues/242)) ([3305b19](https://github.com/bouncrlabs/gmrtd/commit/3305b19806c190cb7fb4a2a2b83afda5b114fc02))
* **csca:** update NL CSCA Master List (7/5/2026) ([#296](https://github.com/bouncrlabs/gmrtd/issues/296)) ([099d0fc](https://github.com/bouncrlabs/gmrtd/commit/099d0fc4d2e98d1c19821bfebaa1a5404ee32d16))
* **csca:** update to latest DE Master List (5/5/2026) ([#293](https://github.com/bouncrlabs/gmrtd/issues/293)) ([aee8204](https://github.com/bouncrlabs/gmrtd/commit/aee8204ad567a80445c26cfe872fb0a320a8b768))
* **csca:** update to latest NL CSCA master-list, dated 22/07/2026 (fixes [#443](https://github.com/bouncrlabs/gmrtd/issues/443)) ([#444](https://github.com/bouncrlabs/gmrtd/issues/444)) ([d2ada80](https://github.com/bouncrlabs/gmrtd/commit/d2ada809cef97b56b9642a4a7813b4627198e3d0))
* decouple ApduLog from DocumentEx, pass it as a separate value ([#416](https://github.com/bouncrlabs/gmrtd/issues/416)) ([89ba49f](https://github.com/bouncrlabs/gmrtd/commit/89ba49f8ae6c72dfab030a57382ef799dd78d033))
* **dg1:** added raw-mrz ([#316](https://github.com/bouncrlabs/gmrtd/issues/316)) ([bb7d1bd](https://github.com/bouncrlabs/gmrtd/commit/bb7d1bdb2ce88d1789c5732b21cc52a70f32d323))
* **document:** add ToCbor/NewDocumentFromCbor for document export/import ([#365](https://github.com/bouncrlabs/gmrtd/issues/365)) ([369c129](https://github.com/bouncrlabs/gmrtd/commit/369c12929920601f93ca6a8cdf242127af8ebbb0))
* **document:** move ApduLog from Session to DocumentEx ([#384](https://github.com/bouncrlabs/gmrtd/issues/384)) ([9f2860c](https://github.com/bouncrlabs/gmrtd/commit/9f2860c6b2b9cde54b4b1ffe32afed807a194b93))
* Elevate Active Authentication (AA) to the highest priority among chip authentication protocols ([#394](https://github.com/bouncrlabs/gmrtd/issues/394)) ([bbf868f](https://github.com/bouncrlabs/gmrtd/commit/bbf868fe96989e0dc994a42620d9dd92978bd60f))
* expose passive authentication stages ([c06b6d5](https://github.com/bouncrlabs/gmrtd/commit/c06b6d555007aee67c6675a00a350711677ba1c4))
* extend reading and evidence verification ([c8fe6eb](https://github.com/bouncrlabs/gmrtd/commit/c8fe6ebad22b4218293d2d970e0fb34501c62115))
* **gmrtd-reader:** updated style for gmrtd-reader output ([#173](https://github.com/bouncrlabs/gmrtd/issues/173)) ([af3c7bb](https://github.com/bouncrlabs/gmrtd/commit/af3c7bb1a836f1ff65ff057b81ebbaa3a019f15c))
* **mobile:** add CountryName helper ([#308](https://github.com/bouncrlabs/gmrtd/issues/308)) ([e2514df](https://github.com/bouncrlabs/gmrtd/commit/e2514df5a604f21a9ea5a132ea3316b5564dcc22))
* **mobile:** Add OidDesc for OID description lookup ([#313](https://github.com/bouncrlabs/gmrtd/issues/313)) ([050f82a](https://github.com/bouncrlabs/gmrtd/commit/050f82aa2a1e4e2d8a5302734e8d5d6f0e5118d6))
* **mobile:** add SkipPace ([#310](https://github.com/bouncrlabs/gmrtd/issues/310)) ([a308158](https://github.com/bouncrlabs/gmrtd/commit/a3081587b3940f5a5bf7f8c751f718fc47e2cb77))
* **mobile:** init CSCA master-list before ReadDocument ([#312](https://github.com/bouncrlabs/gmrtd/issues/312)) ([78fa0d2](https://github.com/bouncrlabs/gmrtd/commit/78fa0d2901fe3864144db06d8d7a5064311daad5))
* moved DG hash checks to PassiveAuth (from Reader) ([#27](https://github.com/bouncrlabs/gmrtd/issues/27)) ([9d81a43](https://github.com/bouncrlabs/gmrtd/commit/9d81a43ec6d5d072d47c617dab79f059c2da887e))
* moved JSON document retrieval to GetDocumentJson ([#72](https://github.com/bouncrlabs/gmrtd/issues/72)) ([938f412](https://github.com/bouncrlabs/gmrtd/commit/938f41224636e56c0714fa3e1477f975484d91e3))
* **mrz:** add OCR-tolerant ConvertMrzToMrzi; optimise NewPasswordMrz ([#405](https://github.com/bouncrlabs/gmrtd/issues/405)) ([c1a1561](https://github.com/bouncrlabs/gmrtd/commit/c1a15616697926914851805fce343e2d6ba8dd14))
* **pace:** add PACE-CAM evidence for offline verification ([#379](https://github.com/bouncrlabs/gmrtd/issues/379)) ([ebba87b](https://github.com/bouncrlabs/gmrtd/commit/ebba87b375c1c1cb190cceb04f6118cf3d56b8d2))
* process other name(s) defined by '0xA0' tag ([#155](https://github.com/bouncrlabs/gmrtd/issues/155)) ([7d2bedd](https://github.com/bouncrlabs/gmrtd/commit/7d2beddf4d27fcabc4795966205ea52cca72175e))
* **reader:** add summary to document session ([#283](https://github.com/bouncrlabs/gmrtd/issues/283)) ([1d57212](https://github.com/bouncrlabs/gmrtd/commit/1d57212f1662923f509a5004dcdc1ff34d191f40))
* **reader:** report read progress as a typed status ([#449](https://github.com/bouncrlabs/gmrtd/issues/449)) ([147c2d5](https://github.com/bouncrlabs/gmrtd/commit/147c2d5dea9a418c299952f14a3410600db2c769))
* separate dynamic data from static document ([#120](https://github.com/bouncrlabs/gmrtd/issues/120)) ([#121](https://github.com/bouncrlabs/gmrtd/issues/121)) ([7bdf361](https://github.com/bouncrlabs/gmrtd/commit/7bdf36181b8b2932ebc0bfa7c2096e62d41cd005))
* **session:** add CBOR serialization for chip auth evidence ([#381](https://github.com/bouncrlabs/gmrtd/issues/381)) ([f0f26c0](https://github.com/bouncrlabs/gmrtd/commit/f0f26c03b9fa3272a982197c424ff285b3e59085))
* update DE CSCA master list (20260108) [fixes:[#157](https://github.com/bouncrlabs/gmrtd/issues/157)] ([#158](https://github.com/bouncrlabs/gmrtd/issues/158)) ([4c0e802](https://github.com/bouncrlabs/gmrtd/commit/4c0e802e349411b8dc9f7c037bd94802cbbd3a20))
* update DE CSCA master list (fixes [#131](https://github.com/bouncrlabs/gmrtd/issues/131)) ([#132](https://github.com/bouncrlabs/gmrtd/issues/132)) ([ca29bdf](https://github.com/bouncrlabs/gmrtd/commit/ca29bdf44ac248caf457d1790c86b1ad2183a47c))
* update DE CSCA master list (fixes [#90](https://github.com/bouncrlabs/gmrtd/issues/90)) ([#91](https://github.com/bouncrlabs/gmrtd/issues/91)) ([f08ef19](https://github.com/bouncrlabs/gmrtd/commit/f08ef19902c291ee02308c4d73e0f7ce711f5d6e))
* update DE CSCA Master-List (fixes [#355](https://github.com/bouncrlabs/gmrtd/issues/355)) ([#356](https://github.com/bouncrlabs/gmrtd/issues/356)) ([9ae5155](https://github.com/bouncrlabs/gmrtd/commit/9ae51558c5401082ceea294d7464ca5f5bbf2dd1))
* update NL CSCA master list (dec 2025) (fixes [#136](https://github.com/bouncrlabs/gmrtd/issues/136)) ([#137](https://github.com/bouncrlabs/gmrtd/issues/137)) ([cd7da89](https://github.com/bouncrlabs/gmrtd/commit/cd7da899f7b476c6aa3e4ba5afe9a38054163fa4))
* update NL CSCA master-list (fixes [#223](https://github.com/bouncrlabs/gmrtd/issues/223)) ([#224](https://github.com/bouncrlabs/gmrtd/issues/224)) ([ec03dae](https://github.com/bouncrlabs/gmrtd/commit/ec03daee0bb07e84dd5a87f21b29213a72fb5732))
* update NL CSCA master-list [fixes [#175](https://github.com/bouncrlabs/gmrtd/issues/175)] ([#176](https://github.com/bouncrlabs/gmrtd/issues/176)) ([73128bd](https://github.com/bouncrlabs/gmrtd/commit/73128bd7ed4b0dbb7095d7f066485d50bf678c78))
* update to latest NL CSCA master-list (march 2026) [fixes [#204](https://github.com/bouncrlabs/gmrtd/issues/204)] ([#205](https://github.com/bouncrlabs/gmrtd/issues/205)) ([dbaacf0](https://github.com/bouncrlabs/gmrtd/commit/dbaacf081eee04d8c82e455aa3598ad08916bd2e))
* **verifier:** add offline document verification and DocumentEx CBOR serialisation ([#385](https://github.com/bouncrlabs/gmrtd/issues/385)) ([2dc6e58](https://github.com/bouncrlabs/gmrtd/commit/2dc6e58d7bf30e513059a5f30f077309df453331))


### Bug Fixes

* [BUG] Fix for DG2 for GBR passports ([#102](https://github.com/bouncrlabs/gmrtd/issues/102)) ([83583bd](https://github.com/bouncrlabs/gmrtd/commit/83583bd6644f31e76c6a433000f61aea6943aeca))
* accept legacy ICAO and Sdu (NL) ldsSecurityObject content-type OIDs ([#425](https://github.com/bouncrlabs/gmrtd/issues/425)) ([d48f112](https://github.com/bouncrlabs/gmrtd/commit/d48f11221de5f4ffdd19b2a648cadb8f24f1b6bd))
* **activeauth:** enforce minimum RSA modulus size (fixes [#346](https://github.com/bouncrlabs/gmrtd/issues/346)) ([#347](https://github.com/bouncrlabs/gmrtd/issues/347)) ([3d5a76a](https://github.com/bouncrlabs/gmrtd/commit/3d5a76abaf9628374a8d8c5359877a9ce6b13242))
* **activeauth:** support DER-encoded ECDSA signatures for AA ([#188](https://github.com/bouncrlabs/gmrtd/issues/188)) ([43057ff](https://github.com/bouncrlabs/gmrtd/commit/43057ffc22c1f87a5f821e4a2833ddd764652a5c))
* **activeauth:** try all ICAO-permitted hashes for ECDSA AA ([#477](https://github.com/bouncrlabs/gmrtd/issues/477)) ([2068821](https://github.com/bouncrlabs/gmrtd/commit/206882148217822f88044bec1d9f0baf38e4492f))
* add missing checkout for mobile artifact upload ([#304](https://github.com/bouncrlabs/gmrtd/issues/304)) ([bfe065c](https://github.com/bouncrlabs/gmrtd/commit/bfe065cf3d52222a130d9ab5d0b54ba321a206d0))
* add version to mobile interface and cmd app ([#146](https://github.com/bouncrlabs/gmrtd/issues/146)) ([65916f4](https://github.com/bouncrlabs/gmrtd/commit/65916f4d60586ebd7db64d26323bb2ad5fbfd338))
* address quick-win SonarQube findings in cms.go ([#479](https://github.com/bouncrlabs/gmrtd/issues/479)) ([03e0ec2](https://github.com/bouncrlabs/gmrtd/commit/03e0ec28a8ddc5733e5ae8ca6c2f901619ed01f8))
* alternative curves ([#153](https://github.com/bouncrlabs/gmrtd/issues/153)) ([5b92054](https://github.com/bouncrlabs/gmrtd/commit/5b920548a5bed6327988302bf3c6e1c7f83c00b5))
* android library issues ([#77](https://github.com/bouncrlabs/gmrtd/issues/77)) ([5253e64](https://github.com/bouncrlabs/gmrtd/commit/5253e64ad29dbe74cb4693427026a3ea197452ac))
* bump version for tlv hardening changes ([#170](https://github.com/bouncrlabs/gmrtd/issues/170)) ([967b798](https://github.com/bouncrlabs/gmrtd/commit/967b79895c6d765f4546b770725c11923812a194))
* case insensitive country lookup ([#84](https://github.com/bouncrlabs/gmrtd/issues/84)) ([2b0abcc](https://github.com/bouncrlabs/gmrtd/commit/2b0abcc354a31f650a7ad9d8881c9cb16bbcbf50))
* change TlvTag type to uint32 for Android builds ([#184](https://github.com/bouncrlabs/gmrtd/issues/184)) ([ae36932](https://github.com/bouncrlabs/gmrtd/commit/ae3693266737bed869371525eb3cf90ba32e970b))
* **chipauth:** bound evidence.SmSsc before FillBytes to avoid a panic ([9a5aa0d](https://github.com/bouncrlabs/gmrtd/commit/9a5aa0d0a8794ca8df15e8a6aa768323d3c0a8e9))
* ci mobile release artifact creation ([#302](https://github.com/bouncrlabs/gmrtd/issues/302)) ([a45461d](https://github.com/bouncrlabs/gmrtd/commit/a45461daaf1ea1ab0caae67d4c105863bc945dd6))
* **cms:** certificate selection fails when SI uses IssuerAndSerialNumber ([#353](https://github.com/bouncrlabs/gmrtd/issues/353)) ([cfd2102](https://github.com/bouncrlabs/gmrtd/commit/cfd2102c6d939f6a91b636a139240ac541d9ee23))
* **cms:** enforce sod/certificate validity (fixes [#329](https://github.com/bouncrlabs/gmrtd/issues/329)) ([#330](https://github.com/bouncrlabs/gmrtd/issues/330)) ([1b5c48c](https://github.com/bouncrlabs/gmrtd/commit/1b5c48cc3027f0700ede1bf3b6762f8509aae4ca))
* **cms:** nil-deref panic in BySKI/ByIssuerCountry (fixes [#343](https://github.com/bouncrlabs/gmrtd/issues/343)) ([#344](https://github.com/bouncrlabs/gmrtd/issues/344)) ([1ba6f61](https://github.com/bouncrlabs/gmrtd/commit/1ba6f61e9a997cdb98437a30de6ecc68cd82029f))
* **cms:** SOD/Cert validation enhancements (fixes [#326](https://github.com/bouncrlabs/gmrtd/issues/326)) ([#327](https://github.com/bouncrlabs/gmrtd/issues/327)) ([a41d338](https://github.com/bouncrlabs/gmrtd/commit/a41d338a0abda52a9cf8f9c813ef4768e2169c49))
* **cms:** tolerant DS certificate selection for issuerAndSerial SODs … ([#441](https://github.com/bouncrlabs/gmrtd/issues/441)) ([632311e](https://github.com/bouncrlabs/gmrtd/commit/632311e627d36d3d9f5d0dfe1f30f879481b885c))
* Concurrent use of Reader/Verifier corrupts Go heap (fatal error: bulkBarrierPreWrite) ([#434](https://github.com/bouncrlabs/gmrtd/issues/434)) ([15167b6](https://github.com/bouncrlabs/gmrtd/commit/15167b60824597e1e7cb27eadeb04c464a5157b0))
* correct RSA signature verification for authentication ([#106](https://github.com/bouncrlabs/gmrtd/issues/106)) ([7694080](https://github.com/bouncrlabs/gmrtd/commit/7694080a08716f31b3a91333dc0f211098f110c3))
* country mappings for hong kong and hungary ([#140](https://github.com/bouncrlabs/gmrtd/issues/140)) ([56c089f](https://github.com/bouncrlabs/gmrtd/commit/56c089f902ad8ea57b1fe4ca0c859230eb19b2b8))
* **crypto-utils:** DecodeX962EcPoint returns nil instead of error ([#335](https://github.com/bouncrlabs/gmrtd/issues/335)) ([fff61a8](https://github.com/bouncrlabs/gmrtd/commit/fff61a835143e87278a1cfb27d669594a8b3557d))
* **cryptoutils:** preserve leading zeros in RSA public key decryption ([#104](https://github.com/bouncrlabs/gmrtd/issues/104)) ([e2e435d](https://github.com/bouncrlabs/gmrtd/commit/e2e435d3e7a5893638d3d29e2fca08dd53675f94))
* **dg12:** json output, changed 'details' to 'documentDetails' ([#429](https://github.com/bouncrlabs/gmrtd/issues/429)) ([09f131f](https://github.com/bouncrlabs/gmrtd/commit/09f131febbd15e33af2a38fa45b35745d78ed275))
* **document:** resolve DateOfExpiry to full 4-digit year in IdentityAttributes ([#431](https://github.com/bouncrlabs/gmrtd/issues/431)) ([07a2227](https://github.com/bouncrlabs/gmrtd/commit/07a22272de4be3d1cee02789fff9e647745df5b8))
* **document:** unbounded count parsing for DG11/DG12 names (fixes [#323](https://github.com/bouncrlabs/gmrtd/issues/323)) ([#324](https://github.com/bouncrlabs/gmrtd/issues/324)) ([1ad42f6](https://github.com/bouncrlabs/gmrtd/commit/1ad42f60a128d740df9ab17c411eba8155c545d5))
* don't panic in processResponse when bad data length ([#31](https://github.com/bouncrlabs/gmrtd/issues/31)) ([7c43eeb](https://github.com/bouncrlabs/gmrtd/commit/7c43eeb381ea253a50e87acf5cac6f7681a10dac))
* extended length fallback issue with Chinese passport (fixes [#457](https://github.com/bouncrlabs/gmrtd/issues/457)) ([#458](https://github.com/bouncrlabs/gmrtd/issues/458)) ([d645bb1](https://github.com/bouncrlabs/gmrtd/commit/d645bb17dbbe7a633ac57022d3cb7445518ca08b))
* **gmrtd-reader:** update template for PACE-CAM and AA struct changes ([#383](https://github.com/bouncrlabs/gmrtd/issues/383)) ([ef06873](https://github.com/bouncrlabs/gmrtd/commit/ef06873939e304b5b61bed81a2e33e05d5ec19ca))
* go version bump to address ios crash ([#465](https://github.com/bouncrlabs/gmrtd/issues/465)) ([690f365](https://github.com/bouncrlabs/gmrtd/commit/690f365ad30c352dfe004a8261d840e70141d55a))
* Improve SelectMF robustness across passport vendors (fixes [#460](https://github.com/bouncrlabs/gmrtd/issues/460)) ([#461](https://github.com/bouncrlabs/gmrtd/issues/461)) ([2be14ef](https://github.com/bouncrlabs/gmrtd/commit/2be14efc0ddfc86fb26eb50eda06e6baebd049a5))
* incomplete image detection ([#94](https://github.com/bouncrlabs/gmrtd/issues/94)) ([#95](https://github.com/bouncrlabs/gmrtd/issues/95)) ([2e6844d](https://github.com/bouncrlabs/gmrtd/commit/2e6844d6f0ce81f625d96aa6100517a6f40a7b72))
* incorrect OIDs and enhanced SecurityInfos UTs (fixes:[#161](https://github.com/bouncrlabs/gmrtd/issues/161)) ([#162](https://github.com/bouncrlabs/gmrtd/issues/162)) ([d8e393c](https://github.com/bouncrlabs/gmrtd/commit/d8e393c40b5d823aecce36ba07d380c31cb70d02))
* IsImage panics with malicious or malformed data [fixes [#198](https://github.com/bouncrlabs/gmrtd/issues/198)] ([#199](https://github.com/bouncrlabs/gmrtd/issues/199)) ([72164e7](https://github.com/bouncrlabs/gmrtd/commit/72164e7a33e1667c0bb476fca1e50e97e29292de))
* **iso7816:** graceful ReadFile fallback for passports with limited READ BINARY Le ([#410](https://github.com/bouncrlabs/gmrtd/issues/410)) ([44cc730](https://github.com/bouncrlabs/gmrtd/commit/44cc730b3004fceebbc54c174fcf2e8ce7b95ed6))
* **iso7816:** SM.Decode downgrade attack vuln (fixes [#320](https://github.com/bouncrlabs/gmrtd/issues/320)) ([#321](https://github.com/bouncrlabs/gmrtd/issues/321)) ([c949ef0](https://github.com/bouncrlabs/gmrtd/commit/c949ef02273ef84245908baf3d300b68900eebfd))
* **iso7816:** tolerate SW 6A87 in SelectMF for Ukrainian passports ([#414](https://github.com/bouncrlabs/gmrtd/issues/414)) ([f706fe0](https://github.com/bouncrlabs/gmrtd/commit/f706fe0e390959695892aee7d75b698c5902810c))
* **makefile:** disabled async preempt for mobile builds ([#438](https://github.com/bouncrlabs/gmrtd/issues/438)) ([703d859](https://github.com/bouncrlabs/gmrtd/commit/703d85949e532fe56d07d9a838b45d0f0a08f074))
* **mobile:** Add Android 16 KB page-size compatible AAR ([#373](https://github.com/bouncrlabs/gmrtd/issues/373)) ([708ae22](https://github.com/bouncrlabs/gmrtd/commit/708ae22eff863721419183117493d91b2068aae7))
* only consider EC keys (getIcPubKeyECForCAM) ([#48](https://github.com/bouncrlabs/gmrtd/issues/48)) ([8906cca](https://github.com/bouncrlabs/gmrtd/commit/8906cca08c515874730cc8e8ba62594ab48bddf7))
* **pace:** PACE error on older Ukrainian passports [fixes [#108](https://github.com/bouncrlabs/gmrtd/issues/108)] ([#109](https://github.com/bouncrlabs/gmrtd/issues/109)) ([9a73dcf](https://github.com/bouncrlabs/gmrtd/commit/9a73dcffb02940e547a6209a9b24aa7bd5109b06))
* **pace:** select the CAM chip authentication key by KeyId ([#447](https://github.com/bouncrlabs/gmrtd/issues/447)) ([33dc6de](https://github.com/bouncrlabs/gmrtd/commit/33dc6de38fd043cafafd9c710d1a5432416cf969))
* **reader:** EF.DIR read error on US passport (fixes [#226](https://github.com/bouncrlabs/gmrtd/issues/226)) ([#227](https://github.com/bouncrlabs/gmrtd/issues/227)) ([cd6f094](https://github.com/bouncrlabs/gmrtd/commit/cd6f094c93fe24b45f546295e2c5b174f67b9775))
* **reader:** fail closed on PACE error unless BAC fallback opted in ([#446](https://github.com/bouncrlabs/gmrtd/issues/446)) ([1701e74](https://github.com/bouncrlabs/gmrtd/commit/1701e74a746a260a5e1707f0c5ef34e100feb32b))
* reject malformed chip authentication evidence ([df05c71](https://github.com/bouncrlabs/gmrtd/commit/df05c7163823552fd468ec218406a1ab82fe47b0))
* release-please config ([#22](https://github.com/bouncrlabs/gmrtd/issues/22)) ([e1d841e](https://github.com/bouncrlabs/gmrtd/commit/e1d841e3545aaf686c85f63827de50be86b3c69a))
* remove a csca from the nl master list ([295bd5f](https://github.com/bouncrlabs/gmrtd/commit/295bd5fff5e2ea38ed4b0358600fa646aa6bbe61))
* resolve incorrect warning about remaining bytes ([#209](https://github.com/bouncrlabs/gmrtd/issues/209)) ([e314c62](https://github.com/bouncrlabs/gmrtd/commit/e314c62864aebba027c9538c150a388547e5d797))
* **secure-messaging:** prevent panic if protected status (tag99) is in… ([#274](https://github.com/bouncrlabs/gmrtd/issues/274)) ([62b27c5](https://github.com/bouncrlabs/gmrtd/commit/62b27c574ecaf3d862bad09c45ae3d1910490693))
* **security:** gate chip authenticity verdict on passive authentication ([#350](https://github.com/bouncrlabs/gmrtd/issues/350)) ([002afb7](https://github.com/bouncrlabs/gmrtd/commit/002afb76df541ec33908163a04b3c9c988ab6bd2))
* sonar warning for debug.PrintStack() ([#474](https://github.com/bouncrlabs/gmrtd/issues/474)) ([6331c71](https://github.com/bouncrlabs/gmrtd/commit/6331c71fb02ea978efa44a7001048b6a30451da0))
* test release artifacts ([#300](https://github.com/bouncrlabs/gmrtd/issues/300)) ([cb74bee](https://github.com/bouncrlabs/gmrtd/commit/cb74beec68923e02b8e2163a937ab23795f429dc))
* **tlv:** guard against panic when rendering untrusted OID bytes ([a561d37](https://github.com/bouncrlabs/gmrtd/commit/a561d379a10435af741416dce99a629aea361eb2))
* **tlv:** ParseLength panics on 32-bit builds when long-form length e… ([#338](https://github.com/bouncrlabs/gmrtd/issues/338)) ([dcd1b90](https://github.com/bouncrlabs/gmrtd/commit/dcd1b904512aa40a1c7e4bf689da323109f7e8a7))
* **tlv:** tlv.Decode unbounded recursion and O(n²) buffer cloning  ([#341](https://github.com/bouncrlabs/gmrtd/issues/341)) ([5dbbe6e](https://github.com/bouncrlabs/gmrtd/commit/5dbbe6e30b5c9aa9ae62890bf1bba649a15a6f4d))
* trigger patch release for v0.17.2 ([#165](https://github.com/bouncrlabs/gmrtd/issues/165)) ([03474d4](https://github.com/bouncrlabs/gmrtd/commit/03474d44c33c9bc59da9583c18e92be501e85f06))
* trim empty strings from DG11 fields caused by leading/trailing/repeated filler chars ([#427](https://github.com/bouncrlabs/gmrtd/issues/427)) ([33582a6](https://github.com/bouncrlabs/gmrtd/commit/33582a6e8a3f12504f3900ef6b7697dce9c47abe))
* update to make JSON field name consistent ([#70](https://github.com/bouncrlabs/gmrtd/issues/70)) ([a459bc4](https://github.com/bouncrlabs/gmrtd/commit/a459bc4d1f3d0e3595db203deca2a767a2bc74d1))
* **utils:** bound BytesFromBuffer allocation to avoid unbounded-length DoS ([33aefae](https://github.com/bouncrlabs/gmrtd/commit/33aefae6f3777870378c154af0f9446526268cf6))
* **verifier:** close Passive-Auth completeness gap in offline/mobile verification path ([#412](https://github.com/bouncrlabs/gmrtd/issues/412)) ([106cb4f](https://github.com/bouncrlabs/gmrtd/commit/106cb4f04d20e7402c079e50cf7c1e27ededc505))
